using Ionic.Zip;
using NetSatis.EDonusum.FitEFatura;
...
{
    public class EFaturaGonderController
    {
        StringWriter SW1;
        FileStream FS;
        ...
        public void FaturaEFaturaGondermeIslemi(List<Donusum.MasterView> m)
        {
            foreach (var d in m)
            {
                var verilist=d.master;
                DateTime dt = Convert.ToDateTime(verilist.IslemTarihi);
                #region Fields
                string _ProfileId = "";
                string _ID = "";
                string _VKNSONUC = "";
                ...
                string _ASP_VKN = d.VergiNumarasi;
                string _ASP_WebAdres = "";
                string _ASP_NAME = d.MusteriAdi;
                ...
                InvoiceType earsiv = new InvoiceType()
                {
                    ...
                    InvoiceLine = InvoiceLineDoldur(verilist.Id),
