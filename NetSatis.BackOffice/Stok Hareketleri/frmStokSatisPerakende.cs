...
{
    public partial class frmStokSatisPerakende : Form

    {
        NetSatisContext context = new NetSatisContext();
        StokHareketDAL stokHareketDal = new StokHareketDAL();
        string DosyaYolu = $@"{Application.StartupPath}\Gorunum\StokSatissPerakendeSavedLayout.xml";
        public frmStokSatisPerakende(DateTime baslangic, DateTime bitis)
        {
            InitializeComponent();
            gridContStokHareket.DataSource = stokHareketDal.StokSatisListeletPerakendeTarih(context, "Stok Çıkış","Perakende Satış Faturası", baslangic, bitis);
        }
        ...
        private void frmStokSatisPerakende_Load(object sender, EventArgs e)
        {
        ...
        private void frmStokSatisPerakende_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void frmStokSatisPerakende_FormClosing(object sender, FormClosingEventArgs e)
        {
