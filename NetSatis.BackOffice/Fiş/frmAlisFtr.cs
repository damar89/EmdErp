...
{
    public partial class frmAlisFtr : Form
    {
        ...
        private void frmAlisFtr_Load(object sender, EventArgs e)
        {
            Listele();
        }
        ...
        private void Listele()
        {
            ...
            gridContFisler.DataSource = fisDal.Listelemeler(context,"Alış Faturası");
        ...
        private void frmAlisFtr_KeyDown(object sender, KeyEventArgs e)
        {
