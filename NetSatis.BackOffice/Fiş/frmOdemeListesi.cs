...
namespace NetSatis.BackOffice.Fiş
{
    public partial class frmOdemeListesi : Form
    {
        ...
        public frmOdemeListesi(DateTime baslangic, DateTime bitis)
        {
            InitializeComponent();
            gridContFisler.DataSource = fisDal.Listelemeler2(context, "Ödeme Fişi", "Alış Faturası", "Satış İade Faturası", baslangic, bitis);
        }
