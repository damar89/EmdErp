...
namespace NetSatis.BackOffice.Fiş
{
    public partial class frmFaturaYazdir : Form
    {
        ...
        int user = 0;
        string DosyaYolu = $@"{Application.StartupPath}\Gorunum\frmFaturaYazdir.xml";
        public frmFaturaYazdir(DateTime baslangic, DateTime bitis, int userId = 0)
        {
            user = userId;
            InitializeComponent();
            gridContFisler.DataSource = fisDal.FaturaYazdir(context, "Perakende Satış Faturası", "Toptan Satış Faturası", "Alış İade Faturası", "Pos Fatura", baslangic, bitis);
        }
