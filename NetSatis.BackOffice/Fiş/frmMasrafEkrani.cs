...
{
    public partial class frmMasrafEkrani : Form
    {
        ...
        private void frmMasrafEkrani_Load(object sender, EventArgs e)
        {
        ...
        private void frmMasrafEkrani_KeyDown(object sender, KeyEventArgs e)
        {
