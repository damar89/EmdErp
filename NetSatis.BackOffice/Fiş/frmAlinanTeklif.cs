...
{
    public partial class frmAlinanTeklif : Form
    {
        ...
        public frmAlinanTeklif()
        {
            InitializeComponent();
        }

        private void frmAlinanTeklif_Load(object sender, EventArgs e)
        {
            Listele();
        }
        ...
        private void Listele()
        {
            ...
            gridContFisler.DataSource = fisDal.Listelemeler(context, "Alınan Teklif Fişi");
        ...
        private void frmAlinanTeklif_KeyDown(object sender, KeyEventArgs e)
        {
