...
{
    public partial class frmSayimEksigi : Form
    {
        ...
        public frmSayimEksigi()
        {
            InitializeComponent();
        }

        private void frmSayimEksigi_Load(object sender, EventArgs e)
        {
            Listele();
        }
        ...
        private void Listele()
        {
            ...
            gridContFisler.DataSource = fisDal.Listelemeler(context,"Sayım Eksiği İşleme");
