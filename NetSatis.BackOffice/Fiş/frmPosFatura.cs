...
{
    public partial class frmPosFatura : Form
    {
        ...
        private void frmPosFatura_Load(object sender, EventArgs e)
        {
            Listele();
        ...
        private void Listele()
        {
            ...
            gridContFisler.DataSource = fisDal.Listelemeler(context, "Pos Fatura");
        ...
        private void barButtonItem7_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            string secilen = gridFisler.GetFocusedRowCellValue(colFisKodu).ToString();
            FaturaHazirla f = new FaturaHazirla();
            f.ProformaFaturaHazirlama(secilen);
        }
    }
}
