...
{
    public partial class frmSayimFazlasi : Form
    {
        ...
        public frmSayimFazlasi()
        {
            InitializeComponent();
        }

        private void frmSayimFazlasi_Load(object sender, EventArgs e)
        {
            Listele();
        }
        ...
        private void Listele()
        {
            ...
            gridContFisler.DataSource = fisDal.Listelemeler(context,"Sayım Fazlası İşleme");
