...
namespace NetSatis.BackOffice.Stok
{
    public partial class frmStokIslem : XtraForm
    {
        ...
        private void gridBarkod_RowUpdated(object sender, DevExpress.XtraGrid.Views.Base.RowObjectEventArgs e)
        {
        }
        ...
        private void gridContBarkod_Click(object sender, EventArgs e)
        {
        }
