...
namespace NetSatis.FrontOffice
{
    public partial class frmFrontOffice : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmFrontOffice() {
            ...
            //com2 hızı
            com2Port = new SerialPort("COM2");
            com2Port.BaudRate = 2400;
            com2Port.Parity = Parity.None;
            com2Port.DataBits = 8;
        ...
        private SerialPort com2Port { get; set; }
        private void SeriPortaYaz() {
            try {
                if (calcGenelToplam.EditValue != null) {
                    if (!com2Port.IsOpen)
                        com2Port.Open();
                    com2Port.Write(calcGenelToplam.Text);
                    com2Port.Close();
                }
            } catch (Exception ex) {
            }
